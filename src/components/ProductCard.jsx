...
const ProductCard = ({ productData }) => {
  ...
  return (
    <div className="relative w-full bg-main-bg border border-gray-300 rounded-3xl overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300 group h-full">
      ...
      <Link to={`/product/${productData.id}`} className="block">
        ...
        <div className="p-3 sm:p-4">
          <div className="min-h-15">
            ...
            <h2 className="text-sm sm:text-base font-semibold text-main-text line-clamp-2">
              {name}
            </h2>
          </div>
      ...
      <div className="flex items-center justify-between p-3 sm:p-4 pt-0">
        ...
        <button
          className="bg-black text-white p-2 sm:p-3 rounded-full hover:bg-gold transition-all hover:scale-110"
onClick={() => {
  dispatch(addToCart({
    id: productData.id,
